namespace HLTextureTools
{
    partial class NewWadForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.checkBox1.Text = "为透明纹理保留调色板中的最后一种颜色";
    ...
    ")|*.tiff";
            ...
            // saveWadFileDialog
            // 
            this.saveWadFileDialog.Filter = "半条命纹理文件 (*.wad)|*.wad";
            // 
            // colorPicker
            // 
