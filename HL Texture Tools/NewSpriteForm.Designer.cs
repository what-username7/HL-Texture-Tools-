namespace HLTextureTools
{
    partial class NewSpriteForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.radioFacingUpright.Text = "正面朝上";
            ...
            this.radioParallelOriented.Text = "平行定向";
            ...
            this.radioParallelUpright.Text = "平行直立";
            ...
            this.label6.Text = "默认类型，图像始终面向相机";
            // 
            // radioOriented
            // 
            ...
            this.radioNormalTexture.Text = "普通";
            ...
            this.label2.Text = "调色板中的最后一种颜色是透明色";
            // 
            // label5
            // 
            ...
            this.label5.Text = "灰度，调色板中的最后一种颜色是sprite的颜色";
            // 
            ...
            this.buttonSaveSprite.Text = "保存sprite";
            ...
            // addImagesFileDialog
            // 
            this.addImagesFileDialog.Filter = "图像文件|*.bmp;*.png;*.jpg;*.gif;*.tiff|Bitmap 文件 (*.bmp)|*.bmp|PNG 文件 (" +
    "*.png)|*.png|JPEG 文件 (*.jpg)|*.jpg|Gif 文件 (*.gif)|*.gif|Tiff 文件 (*.tiff" +
    ")|*.tiff";
            this.addImagesFileDialog.Multiselect = true;
            // 
            // saveSpriteFileDialog
            // 
            this.saveSpriteFileDialog.Filter = "HL SPR 文件 (*.spr)|*.spr";
            // 
            // NewSpriteForm
            // 
            this.AllowDrop = true;
